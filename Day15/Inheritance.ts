...
// Method Overriding:
// A subclass/child can provide a specific implementation of a method that is already defined in its superclass.
// The method must have the same name, return type, and parameters.


//A --- properties + methods     (Parent class/ BaseClass / SuperClass)
...
//Usage
//Create Honda object
let honda= new Honda("Honda","Red","Civic",2024);
...
honda.displayInformation(); //Name: Honda, Color: Red, Model: Civic   ------       Parent class
honda.stop();  //Car stopped...  ------  Parent class
honda.yom();  //Name: Honda, Color: Red, Model: Civic, YOM: 2024  ------       child class
...
let car:Car=new Honda("Honda","Red","Civic",2024);
car.displayInformation(); //Name: Honda, Color: Red, Model: Civic
car.start(); //Honda started...  -- child class
//car.yom(); //not accessible - defined inside the child class. but not the parent class
